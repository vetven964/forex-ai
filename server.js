...
const AI_ENGINE_VERSION = 'advanced-mtf-ict-v6.2-premium';
...
async function buildXauAnalysis() {
  ...
  const scoreItems=[
    {key:'mtf',label:'MTF alignment',points:biasOk?20:0,max:20,passed:biasOk},
