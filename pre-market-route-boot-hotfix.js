/* V-TRADE AI — Pre-Market route boot hotfix V5 */
'use strict';
const fs=require('fs');const path=require('path');const SERVER=path.join(__dirname,'server.js');const MARKER='VTRADE_PREMARKET_ROUTE_BOOT_HOTFIX_V5';
...
`;
  source=source.replace(anchor,anchor+patch);console.log('[V-TRADE PRE-MARKET] ROUTE BOOT HOTFIX V5 APPLIED');
 }
