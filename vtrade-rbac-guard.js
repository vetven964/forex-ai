...
(() => {
  ...
  const isAdminPage=file==='admin-dashboard.html', isUserPage=file==='premium-dashboard-live.html';
  ...
  function installAdminMobileUI(){
    ...
    const style=document.createElement('style');style.id='vtradeAdminMobileUIStyle';style.textContent=`
#vtradeAdminMobileUI{display:none}@media(max-width:700px){body{padding:7px 7px 88px!important;overflow-x:hidden!important}.shell{width:100%!important;max-width:100%!important}.top{position:relative!important;display:flex!important;flex-direction:row!important;align-items:center!important;min-height:62px!important;padding:9px 10px!important;gap:8px!important;overflow:visible!important}.top .brand{min-width:0!important;flex:1!important}.top .brand h1{font-size:16px!important;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.top .brand small{font-size:9px!important}.top .actions{display:none!important}.vta-menu-btn{display:grid;place-items:center;flex:0 0 44px;width:44px;height:44px;border:1px solid #233552;border-radius:11px;background:#0b1423;color:#fff;font-size:20px}.vta-drawer{position:fixed;inset:0 0 0 auto;width:min(86vw,330px);z-index:5000;background:#07101df9;border-left:1px solid #233552;box-shadow:-20px 0 60px #000b;padding:16px;transform:translateX(105%);transition:transform .2s ease;display:flex;flex-direction:column}.vta-drawer.open{transform:none}.vta-overlay{position:fixed;inset:0;z-index:4999;background:#0009;opacity:0;pointer-events:none;transition:.2s}.vta-overlay.open{opacity:1;pointer-events:auto}.vta-drawer-head{display:flex;justify-content:space-between;align-items:center;padding:4px 0 14px;border-bottom:1px solid #17253a}.vta-drawer-title{font-weight:900;font-size:16px}.vta-close{width:40px;height:38px;border:1px solid #233552;border-radius:10px;background:#0b1423;color:#fff;font-size:20px}.vta-links{display:grid;gap:7px;margin-top:14px}.vta-links a,.vta-links button{display:flex;align-items:center;gap:10px;min-height:46px;padding:0 12px;border:1px solid #17253a;border-radius:11px;background:#09111e;color:#dbe4f3;text-decoration:none;font-weight:800;font-size:12px}.vta-links .active{background:#24104f;border-color:#7041ee;color:#fff}.vta-links button{font:inherit;cursor:pointer;text-align:left}.vta-live{margin-top:auto;padding:13px 4px;border-top:1px solid #17253a;color:#22e58a;font-size:10px;font-weight:900}#vtradeAdminMobileUI{display:grid;position:fixed;left:7px;right:7px;bottom:7px;z-index:4900;height:68px;grid-template-columns:repeat(5,1fr);gap:4px;padding:6px;background:#07101df5;border:1px solid #233552;border-radius:18px;box-shadow:0 18px 50px #000b;backdrop-filter:blur(18px)}#vtradeAdminMobileUI a,#vtradeAdminMobileUI button{border:0;background:transparent;color:#9eabc0;text-decoration:none;border-radius:12px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;font-size:9px;font-weight:900}.vta-active{background:#24104f!important;color:#c6b4ff!important}.stats{grid-template-columns:repeat(2,minmax(0,1fr))!important}.card{min-width:0!important}.market{grid-template-columns:1fr!important}.table-wrap{max-width:100%;overflow-x:auto}.toolbar{grid-template-columns:1fr!important}.toolbar .btn{width:100%}.plan{grid-template-columns:1fr!important}.section-title{align-items:flex-start;flex-wrap:wrap}}
`;
