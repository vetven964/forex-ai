...
@media(max-width:900px){.vtrade-account{grid-column:2;grid-row:3;width:100%;margin:3px 0 0}.vtrade-account-btn{width:100%;justify-content:flex-start}.vtrade-account-name{max-width:none}.vtrade-menu{position:absolute;left:0;right:auto;top:52px;width:min(245px,calc(100vw - 24px))}}
`;
    document.head.appendChild(css);
    const layer = document.createElement('div'); layer.id = 'vtradeAccountLayer'; layer.className = 'vtrade-account';
    layer.innerHTML = `<button class="vtrade-account-btn" type="button" aria-expanded="false" aria-label="Account menu"><span class="vtrade-avatar" id="vtradeAvatar">V</span><span class="vtrade-account-name"><span id="vtradeAccountName">Account</span><span class="vtrade-account-role" id="vtradeAccountRole">Session</span></span><span class="vtrade-chevron">⌄</span></button><div class="vtrade-menu" id="vtradeAccountMenu"><div class="vtrade-menu-head"><b id="vtradeMenuName">Account</b><small id="vtradeMenuEmail">Authenticated session</small></div><a id="vtradeUserLink" href="${USER_DASHBOARD}">▣ User Dashboard</a><a id="vtradeAdminLink" class="admin-link" href="${ADMIN_DASHBOARD}">♛ Admin Dashboard</a><button class="logout" id="vtradeLogout" type="button">↪ Sign out</button></div>`;
...
@media(max-width:900px){.app{display:block;min-height:100dvh}.side{height:100dvh;max-height:100dvh;padding-top:max(18px,var(--safe-top));padding-bottom:max(18px,var(--safe-bottom));overscroll-behavior:contain;-webkit-overflow-scrolling:touch}.top{width:100%;min-height:0;padding:calc(9px + var(--safe-top)) 10px 9px;grid-template-columns:44px minmax(0,1fr);align-items:center;overflow:visible}.mobile{width:44px;height:44px;min-width:44px;min-height:44px;grid-row:1 / span 3}.pair{min-width:0;max-width:100%;gap:7px}.pair>div{min-width:0}.pair b,.pair .sub{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.price{font-size:clamp(24px,7vw,29px);line-height:1.05}.live{white-space:nowrap;font-size:10px}.backend{max-width:100%;overflow:hidden;text-overflow:ellipsis}.tfs{grid-column:2;min-width:0;width:100%;margin:3px 0 0;display:flex;gap:5px;overflow-x:auto;overflow-y:hidden;padding:1px 1px 4px;scrollbar-width:none;-webkit-overflow-scrolling:touch;scroll-snap-type:x proximity}.tfs::-webkit-scrollbar{display:none}.tfs button{flex:0 0 auto;min-width:48px;min-height:44px;padding:9px 11px;scroll-snap-align:start}.lang-row{grid-column:2;width:100%;display:flex;gap:5px;margin-top:1px}.lang-btn{min-width:48px;min-height:42px}.wrap{padding:10px 10px 28px;width:100%}.toolbar{grid-template-columns:minmax(0,1fr) auto;display:grid;gap:8px}.api{width:100%;min-width:0;min-height:46px}.btn{min-height:46px}.cards{grid-template-columns:repeat(2,minmax(0,1fr))}.radar{grid-template-columns:repeat(2,minmax(0,1fr))}.gategrid{grid-template-columns:repeat(2,minmax(0,1fr))}.mainrow{grid-template-columns:1fr}.news-top,.news-grid{grid-template-columns:1fr}.card{padding:14px;border-radius:14px}.section{margin-top:10px}.section-title{align-items:flex-start;gap:8px;flex-wrap:wrap}.section-title h2{font-size:16px;line-height:1.3}.section-title>span{margin-left:auto;text-align:right}.huge{font-size:30px}.big{font-size:22px}.signal-state{font-size:26px}.chart{height:min(48vw,230px);min-height:180px}.news-item{grid-template-columns:auto minmax(0,1fr);gap:9px}.news-actions{grid-column:2}.news-actions a{min-height:40px;display:inline-flex;align-items:center}.news-state{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px}.news-badge{grid-column:1 / -1;width:max-content;max-width:100%}}
@media(max-width:600px){.cards,.radar,.gategrid{grid-template-columns:1fr}.toolbar{grid-template-columns:1fr}.toolbar .btn{width:100%}.kv{font-size:11px}.level{font-size:12px;gap:10px}.level b{font-size:12px;text-align:right;overflow-wrap:anywhere}.footerline,.news-foot{flex-wrap:wrap}.news-foot>*{min-width:0}.news-filter{width:100%}.news-filter button{min-height:40px}.chart{height:200px}.signal{display:block}.signal .huge{margin-top:8px}}
@media(max-width:390px){.top{padding-left:8px;padding-right:8px}.wrap{padding-left:8px;padding-right:8px}.card{padding:12px}.price{font-size:23px}.pair{gap:5px}.star{font-size:17px}.backend{font-size:8px;padding:5px 7px}.tfs button{min-width:46px;padding-left:9px;padding-right:9px}.section-title h2{font-size:15px}.label{font-size:9px}.huge{font-size:27px}.big{font-size:20px}.signal-state{font-size:24px}}
